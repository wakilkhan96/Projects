...
class ConsultantRegisterPage extends StatefulWidget{
  ...
  final Function(String? name, String? email, String? mobile, String? password)? onSubmitted;
  const ConsultantRegisterPage({this.onSubmitted, Key? key}) : super(key: key);
...
class _ConsultantRegisterPageState extends State<ConsultantRegisterPage>{
  ...
  String? nameError, mobileError, emailError, passwordError, confirmPasswordError;
  String randomOTPNumber = "";

  Function(String? name, String? email, String? mobile, String? password)? get onSubmitted =>
      widget.onSubmitted;
  ...
  void submit() async {
    if (validate()) {
      ...
      Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (_) => OTPVerificationPage("123456", "2")),
              (route) => false);
      if (onSubmitted != null) {
        onSubmitted!(name, email, mobile, password);
      }
...
//              onPressed: () => Navigator.pop(context),
              onPressed: () => {
                Navigator.push( context, MaterialPageRoute( builder: (_) => const ConsultantLoginPage(),),)
              },
              child: RichText(
                text: const TextSpan(
