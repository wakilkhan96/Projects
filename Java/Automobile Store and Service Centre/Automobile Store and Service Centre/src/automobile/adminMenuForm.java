...
public class adminMenuForm extends JFrame
{
    ...
    adminMenuForm(String ss)
    {
        ...
        _userTypeLabel.setBounds(170, 105, 180, 20);
        ...
        JButton storeUpdateButton = new JButton("Update Store");
        storeUpdateButton.setBounds(280, 250, 150, 40);
        
        JButton serviceButton = new JButton("Service Station");
        ...
        storeUpdateButton.addActionListener((ActionEvent e) -> 
        {  
            storeUpdateForm ob = new storeUpdateForm(_user);
        ...
        {  
            serviceStationForm ob = new serviceStationForm(_user);
            this.dispose();
            ob.setVisible(true);
